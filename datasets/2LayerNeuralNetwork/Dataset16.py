...
hidden_dim1 = 64  # You can adjust this
hidden_dim2 = 32  # You can adjust this
model = TwoLayerNN(input_dim, hidden_dim1, hidden_dim2)
...
plt.title("2-Layer NN: Predicted vs Actual Values")
plt.show()
